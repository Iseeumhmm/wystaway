...
class ES_Shortcode {
	...
	public static function render_form( $data ) {
		...
		if ( !empty($show_name) && 'no' !== $show_name ) {
			...
			$name_html  = '<div class="es-field-wrap"><label><input type="text" name="name" placeholder="' . $name_place_holder . '" value="" ' . $required . '/></label></div>';
		}
		...
		$email_html = '<div class="es-field-wrap"><label>YeeHaw Booss' . __( 'Email', 'email-subscribers' )  . '*'. '<br/><input class="es_required_field es_txt_email" type="email" name="email" value="" placeholder="' . $email_place_holder  .'" required/></label></div>';
		?>
