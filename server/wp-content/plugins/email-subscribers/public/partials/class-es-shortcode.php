...
class ES_Shortcode {
	...
	public static function render_form( $data ) {
		...
		$email_html = '<div class="es-field-wrap"><label><input class="es_required_field es_txt_email" type="email" name="email" value="" placeholder="' . $email_place_holder  .'" required/></label></div>';
		?>
        ...
        <div class="emaillist">
            <form action="#" method="post" class="es_subscription_form es_shortcode_form" id="es_subscription_form_<?php echo $unique_id; ?>" data-source="ig-es" >
                ...
                <input type="submit" name="submit" class="es_subscription_form_submit es_submit_button es_textbox_button" id="es_subscription_form_submit_<?php echo $unique_id; ?>" value="<?php _e( 'Go', 'email-subscribers' ) ?>"/>
