...
class Optin_Forms {
	...
	public function optinforms_scripts() {
		...
		wp_enqueue_style('optinforms-stylesheet', plugins_url('/css/optinforms.css', __FILE__ ), array(), '1.2.9.2' );
		wp_enqueue_script('placeholder', plugins_url('/js/placeholder.js', __FILE__ ), array(), '1.2.9.2');		
